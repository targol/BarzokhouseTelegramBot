...
ROOMS = {
    "shatoot": {
        ...
        "description": (
            "مناسب برای ۲ نفر.\n"
            "در خانه جدید، امکانات: تخت دونفره، پنکه، بخاری گازی، سرویس بهداشتی ایرانی و حمام مجزا."
        ),
    ...
    "ghali": {
        ...
        "description": (
            "مناسب برای ۳ نفر.\n"
            "در خانه جدید، امکانات: یک تخت دونفره و یک تخت یک نفره، پنکه، بخاری گازی، سرویس بهداشتی فرنگی و حمام مجزا."
        ),
        "price": "۱,۳۰۰,۰۰۰ تومان / اقامت و صبحانه هر نفرشب",
